...
const UserNotActivated = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-emerald-500 to-blue-700 dark:bg-gray-900 dark:from-gray-800 dark:to-gray-900">
      <h1 className="text-5xl md:text-7xl font-bold text-white dark:text-gray-200 mb-10 text-center">
        Error 
      </h1>
      <p className="text-xl md:text-2xl text-gray-200 dark:text-gray-400 mb-5 text-center pb-4">
        Usuario no activado
      </p>
      <Link
        to={"/"}
