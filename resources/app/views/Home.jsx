  ...
  return (
    <div className="flex flex-col md:flex-row h-screen  dark:bg-gray-900">
      ...
      >
        ...
        >
          Sistema Web de Encuestas y Estadísticas para Docentes Asistenciales
        </h1>
        <p
          className={`text-xl md:text-2xl mb-10 text-gray-700 dark:text-gray-400`}
        >
          El sistema brinda información de encuestas y estadísticas para el
          seguimiento a docentes asistenciales.
        </p>
        <div className="flex flex-row gap-4 justify-start">
          <Link
            to="/auth/login"
            className=" transition duration-300  ease-in-out transform hover:scale-105  p-3 px-6  bg-blue-800 text-gray-100 hover:bg-blue-900 dark:bg-blue-700 dark:text-white dark:hover:bg-blue-800 rounded-full text-center justify-center items-center my-auto focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-blue-50 "
          >
            Inicia sesión
          </Link>
          <Link
