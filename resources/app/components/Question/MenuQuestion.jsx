...
const MenuQuestion = ({ changeQuestionType }) => {
  ...
  const menuActions = [
    ...
    },
    {
      ...
      text: "Escala",
      onClick: () => changeQuestionType("rating"),
    },
    {
        ...
        >
          <ul className="py-2 text-sm text-gray-700 dark:text-gray-200">
            {menuActions.map((actionM, index) => (
              <li key={index}>
                <button className=" w-full px-4 py-2 text-left flex items-center hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white focus:outline-none"
