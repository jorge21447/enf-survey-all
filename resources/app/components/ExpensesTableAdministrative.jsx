...
const ExpensesTableAdministrative = () => {
        ...
        <div className="bg-gray-50  dark:bg-gray-900  sm:p-2 antialiased">
          <div className="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                <div className="flex flex-col md:flex-row p-4 md:p-6 gap-4">
                  <div className="text-center flex-1">
                    ...
                    <div className="text-3xl font-bold ">
                      {data && data?.totalBalance ? data?.totalBalance : 0.0}{" "}
                      Bs.
                    </div>
                  </div>
                  <div className="text-center flex-1">
                  ...
                  <div className="text-center flex-1">
                    ...
                    <div className="text-3xl font-bold text-teal-600 dark:text-teal-400">
                      {data && data?.totalSpent ? data?.totalSpent : 0.0} Bs.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
              ...
              {/* Filtros */}
              <div className="flex flex-col w-full md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4 border-t dark:border-gray-700">
                <div className="w-full gap-4 md:w-1/2  flex flex-col lg:flex-row">
...
export default ExpensesTableAdministrative;
