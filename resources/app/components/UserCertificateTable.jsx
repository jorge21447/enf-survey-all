...
const UserCertificateTable = ({ users }) => {
  ...
  return (
    <>
              ...
              <div className="flex-1 flex items-center space-x-2">
                ...
                <h2 className="text-2xl font-semibold ">
                  <span className="text-gray-800 dark:text-gray-100">
                    Lista de Usuarios - Certificados
                  </span>
                </h2>
              </div>
            </div>
            <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4 border-t dark:border-gray-700">
              ...
              <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                <PDFDownloadLink
                  ...
                  document={<CertificatePDF users={results} />}
                ...
                <CSVLink
                  ...
                  filename="user-data-certificate.csv"
                  headers={[
                    { label: "ID", key: "id" },
                      ...
                      >
                        ...
                        <td className="px-4 py-3  font-medium text-gray-900 whitespace-nowrap dark:text-white">
                          ...
                          bg-indigo-700 rounded-lg hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800"
                              document={<CertificatePDF users={[user]} />}
                              fileName="somename.pdf"
                            >
                              {({ blob, url, loading, error }) =>
                                loading ? (
      ...
      {/* // Aqui los certificado Viewer */}
      {/* <div className="w-screen h-screen">
        <PDFViewer className="w-4/5 h-4/5">
          <CertificatePDF users={results} />
        </PDFViewer>
      </div> */}
    </>
  );
